...
- External `<link rel=stylesheet>` panics in blitz-dom (the document URL resolves to a `data:` base during resource resolution). Inline `<style>` is unaffected. W2-pre.
